...
public class InterpreterSuite {
    ...
    static {
        ...
        // sOperations[BytecodeType.DUPLICATE.ordinal()] = new
        // BytecodeOperationDuplicate();
    ...
    public static void performOperation(int index, int argument, Routine routine) {
        ...
        DebugSuite.debugPrint(DebugSuite.DEBUG_MODE_BYTECODE, "OP %s arg: %d",
                operation.getClass().getSimpleName(), argument);
        /*
